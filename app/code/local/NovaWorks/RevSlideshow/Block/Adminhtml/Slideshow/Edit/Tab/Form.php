...
//		));
        ...
        $fieldset->addField('cdn_image_url', 'text', array(
            'name' 		=> 'cdn_image_url',
            'label' 	=> $this->__('CDN Image URL'),
            'title' 	=> $this->__('CDN Image URL'),
            'value'  => '',
        ));
        $fieldset->addField('slide_content', 'editor', array(
            'name'      => 'slide_content',
            'label'     => $this->__('Slide Content'),
            'title'     => $this->__('Slide Content'),
            'style'     => 'height:15em',
            'config'    => Mage::getSingleton('cms/wysiwyg_config')->getConfig(),
            'wysiwyg'   => true,
            'required'  => false,
        ));
//        $fieldset->addField('cdn_mobile_image_url', 'text', array(
//            'name' 		=> 'cdn_mobile_image_url',
//            'label' 	=> $this->__('CDN Mobile Image URL'),
//            'title' 	=> $this->__('CDN Mobile Image URL'),
//            'value'  => '',
//        ));

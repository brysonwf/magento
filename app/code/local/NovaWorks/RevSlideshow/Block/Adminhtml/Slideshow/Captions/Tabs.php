...
class NovaWorks_RevSlideshow_Block_Adminhtml_Slideshow_Captions_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
	public function __construct()
	{
		...
		$this->setTitle($this->__('Homepage Slider / Slide'));
	}
